...
void main() {
  ...
  test('Insert multiple, delete mutliple', () async {
    ...
    db.deleteBefore(DateTime.fromMillisecondsSinceEpoch(
        DateTime.now().millisecondsSinceEpoch -
            1000)); // should delete e2 and e3
    List<Entry> l = await db.queryAllRows();
    expect(l.length, 1);
  ...
  test('Query range', () async {
    ...
    Entry e1 = new Entry(
      time: DateTime.now().millisecondsSinceEpoch ~/ 1000 - 1,
      temp: 99,
      hum: 90,
    );
    ...
    db.insert(e2);
    db.insert(e3);
// should delete e2 and e3
    List<Entry> l = await db.queryInRange(
